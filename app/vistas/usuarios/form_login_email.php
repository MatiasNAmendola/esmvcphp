...
<form method='post' action="?menu=usuarios&submenu=validar_form_login_email" >
	Login: <input id='login' name='login' type='text' size='30' maxlength="30" value='Escribe tu login aquí' onkeyup="limpiar_input('email');" onfocus="limpiar_inicial(this);"/>
	<?php echo \core\HTML_Tag::span_error('login', $datos); ?>
	<br />
	Email: <input id='email' name='email' type='text' size='100' maxlength="30" value='Escribe tu email aquí' onkeyup="limpiar_input('login');"  onfocus="limpiar_inicial(this);"/>
